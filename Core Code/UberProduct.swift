...
public class UberProduct : Printable, DebugPrintable, JSONCreateable, UberObjectHasImage
{
	...
	private convenience init?(productID: String? = nil, name: String? = nil, productDescription: String? = nil, capacity: Int? = nil, imageURL: String? = nil)
	{
		...
		if let id = productID, let name = name, let description = productDescription, let capacity = capacity
		{
	...
	:param: success   The block of code to execute if we successfully create the `UberProduct`
