...
@objc public final class UberUser : NSObject, JSONCreateable, UberObjectHasImage
{
	...
	@objc public override var description : String { get { return "Uber User \(firstName) \(lastName)" } }
