...
@objc public final class UberLocation : NSObject, JSONCreateable
{
	...
	@objc public override var description : String { get { return displayName ?? "Location \(latitude), \(longitude). Orientation \(bearing)°" } }
