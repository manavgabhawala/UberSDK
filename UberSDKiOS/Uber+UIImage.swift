...
private func downloadImage<T: UberObjectHasImage>(object: T, successCallbackBlock success: (T, image: UIImage, fileLocation: String) -> Void, andFailureCallbackBlock failure: UberErrorHandler?)
{
...
public typealias UberProductImageDownloadedBlock = (UberProduct, image: UIImage, fileLocation: String) -> Void

extension UberProduct
{
	/**
	Call this function on an `UberProduct` to `asynchronously` download a product's image.
...
public typealias UberUserImageDownloadedBlock = (UberUser, image: UIImage, fileLocation: String) -> Void
...
public typealias UberDriverImageDownloadedBlock = (UberDriver, image: UIImage, fileLocation: String) -> Void
...
public typealias UberVehicleImageDownloadedBlock = (UberVehicle, image: UIImage, fileLocation: String) -> Void
